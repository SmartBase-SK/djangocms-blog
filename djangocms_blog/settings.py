...
def get_setting(name):
    ...
    default = {
        ...
        'BLOG_FB_APPID': getattr(settings, 'BLOG_FB_APPID', meta_settings.get_setting("FB_APPID")),
        'BLOG_FB_PROFILE_ID': getattr(settings, 'BLOG_FB_PROFILE_ID', meta_settings.get_setting("FB_PROFILE_ID")),
        'BLOG_FB_PUBLISHER': getattr(settings, 'BLOG_FB_PUBLISHER', meta_settings.get_setting("FB_PUBLISHER")),
        ...
        'BLOG_TWITTER_SITE': getattr(settings, 'BLOG_TWITTER_SITE', meta_settings.get_setting("TWITTER_SITE")),
        ...
        'BLOG_MOST_READ_PLUGIN_NAME': getattr(
            settings, 'BLOG_MOST_READ_PLUGIN_NAME', _('Most Read Blog Articles')),
